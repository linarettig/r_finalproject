...
This repository contains the final group project for ERHS 535, which explores trends in U.S. National Park visitation and their relationship with air quality patterns, with a focused analysis on the Intermountain Region. Using an interactive FlexDashboard built in R, we integrate long-term visitation data with environmental and socioeconomic indicators to better understand how air quality conditions may intersect with park use and regional trends.
...
The dashboard integrates multiple publicly available datasets:
...
Slider to animate visitation trends over time

Pop-up details including park name, visitors, state population, and gas prices
...
Interactive dashboards allow users to explore complex, long-term datasets intuitively

Data validation and consistency across sources are critical for smooth integration

Performance optimizations (e.g., leafletProxy) significantly improve user experience

Air quality conditions vary across regions and may influence visitation patterns
